...
class Ship:
    ...
    def keep_working(manager):
        ...
        #     Ship.remove_ships()
        #     # Reiniciar o sort da lista, clicando em base e voltando em spaceship, para que a proxima 
        # vez que ele tentar selecionar as naves, nao fique com a lista mao posicionada na tela
        #     return False
